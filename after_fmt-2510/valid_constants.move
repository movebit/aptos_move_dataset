module 0x42::constants {
    ...
    const V6_256: i256 =
        57896044618658097711785492504343953926634992332820282019728792003956564819967; // constant with annotated type but non-annotated, max value
    const V7_256: i256 =
    ...
    public fun test_i8(): i8 {
        ...
        V1_8 + V2_8 + V3_8 + V4_8 + V5_8 + V6_8 + V7_8 + V8_8 + V9_8 + a_ann + b_ann
            + c_ann + d_ann + e_ann + a + b + c + d + e + x + y + z
    }
    ...
    public fun test_i16(): i16 {
        ...
        let (x, y, z) = (- 1, - 2, - 3); // constants in tuple
        V1_16 + V2_16 + V3_16 + V4_16 + V5_16 + V6_16 + V7_16 + V8_16 + V9_16 + a_ann
            + b_ann + c_ann + d_ann + e_ann + a + b + c + d + e + x + y + z
    }
    ...
    public fun test_i32(): i32 {
        ...
        let (x, y, z) = (- 1, - 2, - 3); // constants in tuple
        V1_32 + V2_32 + V3_32 + V4_32 + V5_32 + V6_32 + V7_32 + V8_32 + V9_32 + a_ann
            + b_ann + c_ann + d_ann + e_ann + a + b + c + d + e + x + y + z
    }
    ...
    public fun test_i64(): i64 {
        ...
        let (x, y, z) = (- 1, - 2, - 3); // constants in tuple
        V1_64 + V2_64 + V3_64 + V4_64 + V5_64 + V6_64 + V7_64 + V8_64 + V9_64 + a_ann
            + b_ann + c_ann + d_ann + e_ann + a + b + c + d + e + x + y + z
    }
    ...
    public fun test_i128(): i128 {
        ...
        let (x, y, z) = (- 1, - 2, - 3); // constants in tuple
        V1_128 + V2_128 + V3_128 + V4_128 + V5_128 + V6_128 + V7_128 + V8_128 + V9_128
            + a_ann + b_ann + c_ann + d_ann + e_ann + a + b + c + d + e + x + y + z
    }
    ...
    public fun test_i256(): i256 {
        ...
        let d_ann =
            57896044618658097711785492504343953926634992332820282019728792003956564819967i256; // constant with non-annotated type but annotated, max value
        let e_ann =
            - 57896044618658097711785492504343953926634992332820282019728792003956564819968i256; // constant with non-annotated type but annotated, min value
        let a = 0; // constant with non-annotated type and non-annotated value
        let b = 1; // constant with non-annotated type and non-annotated value
        let c = - 1; // constant with non-annotated type and non-annotated, negative value
        let d =
            57896044618658097711785492504343953926634992332820282019728792003956564819967; // constant with non-annotated type and non-annotated, max value
        let e =
            - 57896044618658097711785492504343953926634992332820282019728792003956564819968i256; // constant with non-annotated type and non-annotated, min value
        let (x, y, z) = (- 1, - 2, - 3); // constants in tuple
        V1_256 + V2_256 + V3_256 + V4_256 + V5_256 + V6_256 + V7_256 + V8_256 + V9_256
            + a_ann + b_ann + c_ann + d_ann + e_ann + a + b + c + d + e + x + y + z
    }
}
