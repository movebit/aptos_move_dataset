...
module Module {
    ...
    fun c(a: address, x: u64): bool acquires A {
        exists<A>(a) && borrow_global<A>(a).t == x
    }

    fun d<T: store>(a: address, x: u64): bool acquires B {
    ...
    #[test(a1 = @0x1, a2 = @0x2)]
    // testing framework will create and pass-in signers with these addresses
    ...
    #[test(a1 = @0x1, a2 = @0x2)]
    fun tests_c(a1: signer, a2: signer) acquires A {
    ...
    #[test(a1 = @0x1, a2 = @0x2)]
    fun tests_d(a1: signer, a2: signer) acquires B {
