...
script {
    fun main() {
        ...
        assert!(
            0i128 + 170141183460469231731687303715884105727i128
        ...
        assert!(
            5i128 + 170141183460469231731687303715884105722i128
                == 170141183460469231731687303715884105727i128,
            1202
        );
        assert!(
        ...
        assert!(
            -5i128 + -170141183460469231731687303715884105723i128
                == -170141183460469231731687303715884105728i128,
            1205
        );
    }
...
script {
    fun main() {
        ...
        assert!(
            170141183460469231731687303715884105727i128 / 7i128
                == 24305883351495604533098186245126300818i128,
            4101
        );
        assert!(
            -170141183460469231731687303715884105727i128 / 7i128
...
script {
    fun main() {
        ...
        assert!(
            170141183460469231731687303715884105727i128 % 7i128 == 1i128, 5101
        );
        assert!(
            -170141183460469231731687303715884105727i128 % 7i128 == -1i128, 5102
        );
    }
}
