...
module aptos_std::multi_key_tests {
    ...
    fun test_construct_multi_key() {
        let pk1 =
            single_key::new_public_key_from_bytes(
                x"0020aa9b5e7acc48169fdc3809b614532a5a675cf7d4c80cd4aea732b47e328bda1a"
            );
        let pk2 =
            single_key::new_public_key_from_bytes(
                x"0020bd182d6e3f4ad1daf0d94e53daaece63ebd571d8a8e0098a02a4c0b4ecc7c99e"
            );
        let multi_key = multi_key::new_multi_key_from_single_keys(vector[pk1, pk2], 1);
        let mk_bytes: vector<u8> =
            x"020020aa9b5e7acc48169fdc3809b614532a5a675cf7d4c80cd4aea732b47e328bda1a0020bd182d6e3f4ad1daf0d94e53daaece63ebd571d8a8e0098a02a4c0b4ecc7c99e01";
    ...
    fun test_get_authentication_key() {
        let mk_bytes: vector<u8> =
            x"02031b68747470733a2f2f6163636f756e74732e676f6f676c652e636f6d2086bc0a0a825eb6337ca1e8a3157e490eac8df23d5cef25d9641ad5e7edc1d51400205da515f392de68080051559c9d9898f5feb377f0b0f15d43fd01c98f0a63b0d801";
        let multi_key = multi_key::new_public_key_from_bytes(mk_bytes);
        assert!(
