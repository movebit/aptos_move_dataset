...
script {
    fun main() {
        1i256
            + 57896044618658097711785492504343953926634992332820282019728792003956564819967i256; // expect abort
    }
}
...
script {
    fun main() {
        -1i256
            + -57896044618658097711785492504343953926634992332820282019728792003956564819968i256; // expect abort
    }
}
...
script {
    fun main() {
        ...
        // near sqrt(max)
        assert!(
            170141183460469231731687303715884105727i256
                * 170141183460469231731687303715884105727i256
                == 28948022309329048855892746252171976962977213799489202546401021394546514198529i256,
            3100
        );
    }
}
...
script {
    fun main() {
        ...
        assert!(
            57896044618658097711785492504343953926634992332820282019728792003956564819967i256
            / 6i256
                == 9649340769776349618630915417390658987772498722136713669954798667326094136661i256,
            4001
        );
        assert!(
            -57896044618658097711785492504343953926634992332820282019728792003956564819967i256
