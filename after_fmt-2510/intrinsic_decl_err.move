module 0x42::M {
    ...
    spec MyTable1 {
        ...
        // expect failure
        pragma intrinsic = map, map_no_such_fun = new;

        // expect failure
        pragma intrinsic = map, map_len = true;

        // expect failure
        pragma intrinsic = map, map_len = 0x1::signer::address_of;

        // expect failure
        pragma intrinsic = map, map_len = no_such_move_fun;

        // expect failure
        pragma intrinsic = map, map_spec_len = no_such_spec_fun;

        // expect failure
        pragma intrinsic = map, map_len = spec_len;

        // expect failure
        pragma intrinsic = map, map_len = length, map_borrow_mut = length;

        // expect failure
        pragma intrinsic = map, map_spec_len = spec_len, map_spec_set = spec_len;
    }
}
