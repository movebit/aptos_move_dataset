module 0x42::valid_struct {
    ...
    struct S1 has copy, drop {
        ...
        y: i64,
        z: i128
    } // struct with i64 and i128 fields

    struct S2 has copy, drop {
        x: S1,
        y: i64,
        z: i128
    } // struct with i64 and i128 fields, as well as nested struct involving i64 and i128

    struct S3<T> has copy, drop {
        x: T,
        y: S1,
        z: S2
    } // struct with two layers of nesting, and generic types
