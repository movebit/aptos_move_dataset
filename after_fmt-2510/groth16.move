...
module groth16_example::groth16 {
    ...
    fun test_verify_circom_proof(fx: signer) {
        ...
        let a_x =
            9291141442484249183824149917322150275993152355313319552386216014158050680949u256;
        let a_y =
            4751084799539532208179359846086616641767957505361605807745261011239799367574u256;
        ...
        let b_x1 =
            4154738608741966676660560127107026081842675422117462672893103452342068780854u256;
        let b_y1 =
            4513470140932917342403349901925141325820502953664313447973655116956106256795u256;
        let b_x2 =
            15981382089229198179693168711034036915586021039523535710774744447138572769902u256;
        let b_y2 =
            11691946641863119124627852663455054061430853487917262585560660740296157381098u256;
        ...
        let c_x =
            19416574444268205378069689424519026208317515867624593374135746889327790637883u256;
        let c_y =
            9387724931669771435449663200581094189180308746057595118467671565223418773035u256;
        ...
        let vk_alpha_x =
            20491192805390485299153009773594534940189261866228447918068658471970481763042u256;
        let vk_alpha_y =
            9383485363053290200918347156157836566562967994039712273449902621266178545958u256;
        ...
        let vk_beta_x1 =
            6375614351688725206403948262868962793625744043794305715222011528459656738731u256;
        let vk_beta_y1 =
            4252822878758300859123897981450591353533073413197771768651442665752259397132u256;
        let vk_beta_x2 =
            10505242626370262277552901082094356697409835680220590971873171140371331206856u256;
        let vk_beta_y2 =
            21847035105528745403288232691147584728191162732299865338377159692350059136679u256;
        ...
        let vk_gamma_x1 =
            10857046999023057135944570762232829481370756359578518086990519993285655852781u256;
        let vk_gamma_y1 =
            11559732032986387107991004021392285783925812861821192530917403151452391805634u256;
        let vk_gamma_x2 =
            8495653923123431417604973247489272438418190587263600148770280649306958101930u256;
        let vk_gamma_y2 =
            4082367875863433681332203403145435568316851327593401208105741076214120093531u256;
        ...
        let vk_delta_x1 =
            11733257046589851891850695012146277477007262722187040969185039828348964552798u256;
        let vk_delta_y1 =
            4027038803827470819590008730534113934894139311083936102089700708335772383417u256;
        let vk_delta_x2 =
            4501048010313692533367858190733760821904297928029128233318781536412685771070u256;
        let vk_delta_y2 =
            7929485975251451284651333169168875690528578182699769192928243180764480545757u256;
        ...
        let vk_gamma_abc_1_x =
            9301933260370907965380929235907744187309044275532228633956723711236164592702u256;
        let vk_gamma_abc_1_y =
            16430819258686105004298644553325509170608676387027348203797023622583733864344u256;
        let vk_gamma_abc_2_x =
            15788660278421993534955189104796829710153510462607851239961905416961864489081u256;
        let vk_gamma_abc_2_y =
            15949953543860974252716711139898663592700226282992131841266708887108944899694u256;
        let vk_gamma_abc_3_x =
            2752114278074204756951480614592040829268118205913128303990769829555505490153u256;
        let vk_gamma_abc_3_y =
            73756394237398953482375632482393116165824820760002925371208078608366682284u256;
        let vk_gamma_abc_4_x =
            6831852747912655055472532439405874457935232091421568713540315004023659266911u256;
        let vk_gamma_abc_4_y =
            17612881006477748801680400530139134796116043408186867599538777507587075595161u256;
        let vk_gamma_abc_5_x =
            17635013362332631023685688861083101650289128874790189338507065664254475202088u256;
        let vk_gamma_abc_5_y =
            6682655906896444146648448177201874759860197304706943082757442475451670349909u256;
        let vk_gamma_abc_6_x =
            9475873236009016297956856337772183876551495716493352835259515853844766276811u256;
        let vk_gamma_abc_6_y =
            354515196483384658424215379959670593913045973021122448612086705709310867552u256;
        let vk_gamma_abc_7_x =
            7739081130943509516619482455397124703705394954310688728375429231271874275446u256;
        let vk_gamma_abc_7_y =
            20649108686175166181372170979134000369449535282768431130801436273782009562466u256;
        let vk_gamma_abc_8_x =
            19048468636913770448398586085397679668705519948654488617907272996340406724088u256;
        let vk_gamma_abc_8_y =
            16091090919051613132321664644473341983081123954146774949203587504747978913249u256;
        let vk_gamma_abc_9_x =
            15589510145441310638849264936668688491890711017850837908639714876170500087371u256;
        let vk_gamma_abc_9_y =
            160324255716095477979225131314833211463231522810162446268019950262710535809u256;
        ...
        let public_2_val =
            7714357208561315320836530795186262204499958856333073618293621003566744654598u256;
        ...
        let public_1 =
            std::option::extract(
                &mut deserialize<bn254_algebra::Fr, bn254_algebra::FormatFrLsb>(
                    &public_1_bytes
                )
            );
        let public_2 =
    ...
    fun test_verify_proof_with_bls12381(fx: signer) {
        ...
        let vk_alpha_g1 =
            std::option::extract(
                &mut deserialize<G1, FormatG1Compr>(
                    &x"9819f632fa8d724e351d25081ea31ccf379991ac25c90666e07103fffb042ed91c76351cd5a24041b40e26d231a5087e"
                )
            );
        let vk_beta_g2 =
            std::option::extract(
        ...
        let proof_a =
            std::option::extract(
                &mut deserialize<G1, FormatG1Compr>(
                    &x"8a7c7364403d91bfa5c723ce93b920c8d2e559ea5e7e34eb68cea437aa4f26bf56ba22d9400988a86f2943c79401e959"
                )
            );
        let proof_b =
            std::option::extract(
                &mut deserialize<G2, FormatG2Compr>(
                    &x"9352f8a2f9ff60d390e363d063354e9728adf39c91294499575855e803dd80eeaa1488cd24d1b80eb1b2625011e22a5d139e24f2c7ac3508874ec4bdb9c71ddf109e7853d641d23ed27bef265248d78eabe9137c03b088d8adbdf39e10f87eab"
                )
            );
        let proof_c =
            std::option::extract(
                &mut deserialize<G1, FormatG1Compr>(
                    &x"896f68b438e076d3017e64aa47621fcd69b45f49a7038e2b1b9ed4f2de9b8eb8e0a76785a39a08f024435811a73a6818"
                )
            );
    ...
    fun test_verify_proof_prepared_with_bls12381(fx: signer) {
        ...
        let pvk_alpha_g1_beta_g2 =
            std::option::extract(
                &mut deserialize<Gt, FormatGt>(
                    &x""
                )
            );
        let pvk_gamma_g2_neg =
            std::option::extract(
                &mut deserialize<G2, FormatG2Compr>(
                    &x"b6750d8445596af8d679487c7267ae9734aeac584ace191d225680a18ecff8ebae6dd6a5fd68e4414b1611164904ee120363c2b49f33a873d6cfc26249b66327a0de03e673b8139f79809e8b641586cde9943fa072ee5ed701c81b3fd426c220"
                )
            );
        let pvk_delta_g2_neg =
            std::option::extract(
                &mut deserialize<G2, FormatG2Compr>(
                    &x"ad3ac832f2508af6f01872ada87ea66d2fb5b099d34c5bac81e7482c956276dfc234c8d2af5fd2394b5440d0708a2c9f124a53c0755e9595cf9f8adade5deefcb8a574a67debd3b74d08c49c23ddc14cd6d48b65dce500c8a5d330e760fe85bb"
                )
            );
        ...
        assert!(
            verify_proof_prepared<G1, G2, Gt, Fr>(
                &pvk_alpha_g1_beta_g2,
                &pvk_gamma_g2_neg,
                &pvk_delta_g2_neg,
                &pvk_gamma_abc_g1,
    ...
    fun test_verify_proof_prepared_fq12_with_bls12381(fx: signer) {
        ...
        let pvk_alpha_g1_beta_g2 =
            std::option::extract(
                &mut deserialize<Fq12, FormatFq12LscLsb>(
                    &x""
                )
            );
        let pvk_gamma_g2_neg =
        ...
        assert!(
            verify_proof_prepared_fq12<G1, G2, Gt, Fq12, Fr>(
                &pvk_alpha_g1_beta_g2,
                &pvk_gamma_g2_neg,
                &pvk_delta_g2_neg,
                &pvk_gamma_abc_g1,
