...
module token_lockup::unit_tests {
    ...
    fun test_happy_path(
        ...
        let token_1_constructor_ref =
            token_lockup::mint_to(creator, string::utf8(b"Token #1"), owner_1_addr);
        let token_2_constructor_ref =
            token_lockup::mint_to(creator, string::utf8(b"Token #2"), owner_2_addr);
        // mint 1 more token to owner_1 one second later
        fast_forward_secs(1);
        let token_3_constructor_ref =
            token_lockup::mint_to(creator, string::utf8(b"Token #3"), owner_1_addr);
