...
module DiemFramework::TreasuryComplianceScripts {
    ...
    spec cancel_burn_with_amount {
        ...
        let total_preburn_value = global<Diem::CurrencyInfo<Token>>(@CurrencyInfo).preburn_value;
        ...
        aborts_with [check] errors::REQUIRES_CAPABILITY, errors::NOT_PUBLISHED, errors::INVALID_ARGUMENT, errors::LIMIT_EXCEEDED, errors::INVALID_STATE;
    ...
    spec burn_with_amount {
        ...
        aborts_with [check] errors::INVALID_ARGUMENT, errors::REQUIRES_CAPABILITY, errors::NOT_PUBLISHED, errors::INVALID_STATE, errors::LIMIT_EXCEEDED;

        include Diem::BurnWithResourceCapEmits<Token> {
            preburn: Diem::spec_make_preburn(amount)
        };
    ...
    spec preburn {
        ...
        aborts_with [check] errors::NOT_PUBLISHED, errors::INVALID_STATE, errors::REQUIRES_ROLE, errors::LIMIT_EXCEEDED;

        /// **Access Control:**
        /// Only the account with a Preburn resource or PreburnQueue resource can preburn [[H4]][PERMISSION].
        aborts_if !(
            exists<Diem::Preburn<Token>>(account_addr)
                || exists<Diem::PreburnQueue<Token>>(account_addr)
        );
    }
    ...
    spec tiered_mint {
        ...
        aborts_with [check] errors::INVALID_ARGUMENT, errors::REQUIRES_ADDRESS, errors::NOT_PUBLISHED, errors::REQUIRES_CAPABILITY, errors::INVALID_STATE, errors::LIMIT_EXCEEDED, errors::REQUIRES_ROLE;
    ...
    public entry fun freeze_account(
        tc_account: signer, sliding_nonce: u64, to_freeze_account: address
    ) {
        SlidingNonce::record_nonce_or_abort(&tc_account, sliding_nonce);
    ...
    spec update_exchange_rate {
        ...
        aborts_with [check] errors::INVALID_ARGUMENT, errors::REQUIRES_ADDRESS, errors::LIMIT_EXCEEDED, errors::REQUIRES_ROLE, errors::NOT_PUBLISHED;
    ...
    public entry fun update_minting_ability<Currency>(
        tc_account: signer, allow_minting: bool
    ) {
    ...
    spec add_vasp_domain {
        ...
        aborts_with [check] errors::REQUIRES_ROLE, errors::REQUIRES_ADDRESS, errors::NOT_PUBLISHED, errors::INVALID_ARGUMENT;
    }
