module aptos_experimental::order_book {
    ...
    use aptos_experimental::single_order_book::{
        SingleOrderBook,
        new_single_order_book,
        SingleOrderRequest
    };
    ...
    public fun reinsert_order<M: store + copy + drop>(
        ...
        assert!(
            reinsert_order.get_book_type_from_match_details()
                == original_order.get_book_type_from_match_details(),
