...
script {
    fun main() {
        ...
        assert!(
            0i64 + 9223372036854775807i64 == 9223372036854775807i64,
            1200
        );
        assert!(
            1i64 + 9223372036854775806i64 == 9223372036854775807i64,
            1201
        );
        assert!(
            5i64 + 9223372036854775802i64 == 9223372036854775807i64,
            1202
        );
        assert!(
            0i64 + - 9223372036854775808i64 == - 9223372036854775808i64,
            1203
        );
        assert!(
            - 1i64 + - 9223372036854775807i64 == - 9223372036854775808i64,
            1204
        );
        assert!(
            - 5i64 + - 9223372036854775803i64 == - 9223372036854775808i64,
            1205
        );
    }
}
...
script {
    fun main() {
        ...
        assert!(
            3037000499i64 * 3037000499i64 == 9223372030926249001i64,
            3200
        );
        assert!(
            - 3037000499i64 * - 3037000499i64 == 9223372030926249001i64,
...
script {
    fun main() {
        ...
        assert!(
            9223372036854775807i64 / 7i64 == 1317624576693539401i64,
            4101
        );
