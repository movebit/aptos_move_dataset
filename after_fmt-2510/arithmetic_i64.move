...
script {
    fun main() {
        ...
        assert!(
            0i64 + 9223372036854775807i64 == 9223372036854775807i64, 1200
        );
        assert!(
            1i64 + 9223372036854775806i64 == 9223372036854775807i64, 1201
        );
        assert!(
            5i64 + 9223372036854775802i64 == 9223372036854775807i64, 1202
        );
        assert!(
            0i64 + -9223372036854775808i64 == -9223372036854775808i64, 1203
        );
        assert!(
            -1i64 + -9223372036854775807i64 == -9223372036854775808i64, 1204
        );
        assert!(
            -5i64 + -9223372036854775803i64 == -9223372036854775808i64, 1205
        );
    }
}
...
script {
    fun main() {
        ...
        assert!(
            0i64 - -9223372036854775807i64 == 9223372036854775807i64, 2200
        );
        assert!(
            1i64 - -9223372036854775806i64 == 9223372036854775807i64, 2201
        );
        assert!(
            5i64 - -9223372036854775802i64 == 9223372036854775807i64, 2202
        );
        assert!(
            -1i64 - 9223372036854775807i64 == -9223372036854775808i64, 2203
        );
        assert!(
            -5i64 - 9223372036854775803i64 == -9223372036854775808i64, 2204
        );
        assert!(
            -9223372036854775808i64 - 0 == -9223372036854775808i64, 2205
        );
    }
}
...
script {
    fun main() {
        ...
        assert!(
            3037000499i64 * 3037000499i64 == 9223372030926249001i64, 3200
        );
        assert!(
            -3037000499i64 * -3037000499i64 == 9223372030926249001i64, 3201
        );
        assert!(
            3037000499i64 * -3037000499i64 == -9223372030926249001i64, 3202
        );
        assert!(
            -3037000499i64 * 3037000499i64 == -9223372030926249001i64, 3203
        );
    }
}
...
script {
    fun main() {
        ...
        assert!(
            9223372036854775807i64 / 7i64 == 1317624576693539401i64, 4101
        );
        assert!(-6i64 / 3i64 == -2i64, 4102);
        assert!(
            -9223372036854775807i64 / 7i64 == -1317624576693539401i64, 4103
        );
        assert!(6i64 / -3i64 == -2i64, 4104);
        assert!(
            9223372036854775807i64 / -7i64 == -1317624576693539401i64, 4105
        );
        assert!(-6i64 / -3i64 == 2i64, 4106);
        assert!(
            -9223372036854775807i64 / -7i64 == 1317624576693539401i64, 4107
        );
    }
}
