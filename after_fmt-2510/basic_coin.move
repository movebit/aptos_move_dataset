...
module named_addr::basic_coin {
    ...
    public fun mint(
        module_owner: &signer, mint_addr: address, amount: u64
    ) acquires Balance {
    ...
    #[test(account = @0x1)]
    // Creates a signer for the `account` argument with address `@0x1`
    #[expected_failure]
    ...
    // Creates a signer for the `account` argument with the value of the named address `named_addr`
