...
module DiemFramework::CRSNTests {
    ...
    #[test(a = @0xCAFE, tc = @TreasuryCompliance, dr = @DiemRoot)]
    public fun publish_exists_after_small_size(
    ...
    #[test(a = @0xCAFE, tc = @TreasuryCompliance, dr = @DiemRoot)]
    public fun publish_exists_after_medium_size(
        a: signer, tc: signer, dr: signer
    ) {
        setup(&dr, &tc, &a);
        let addr = signer::address_of(&a);
    ...
    #[test(a = @0xCAFE, tc = @TreasuryCompliance, dr = @DiemRoot)]
    public fun publish_exists_after_large_size(
        a: signer, tc: signer, dr: signer
    ) {
        setup(&dr, &tc, &a);
        let addr = signer::address_of(&a);
    ...
    #[test(a = @0xCAFE, tc = @TreasuryCompliance, dr = @DiemRoot)]
    public fun force_expire_shift_over_set_bits(
        a: signer, tc: signer, dr: signer
    ) {
        setup(&dr, &tc, &a);
        let addr = signer::address_of(&a);
    ...
    #[test(a = @0xCAFE, tc = @TreasuryCompliance, dr = @DiemRoot)]
    public fun force_expire_past_window_size(
        a: signer, tc: signer, dr: signer
    ) {
        setup(&dr, &tc, &a);
        let addr = signer::address_of(&a);
