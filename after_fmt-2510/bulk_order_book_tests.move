...
module aptos_experimental::bulk_order_book_tests {
    ...
    use aptos_experimental::bulk_order_book_types::{
        ...
        destroy_bulk_order_request_response,
        is_bulk_order_success_response,
        destroy_bulk_order_place_success_response,
        destroy_bulk_order_place_reject_response,
        is_success
    };
    ...
    fun setup_test(): (
        ...
        order_book.place_bulk_order(
            &mut price_time_idx, &mut ascending_id_generator, order_request
        );
    ...
    fun create_test_order_request(
        ...
        let (request_option, _rejection_reason_option) =
            destroy_bulk_order_request_response(response);
    ...
    fun verify_match_basic(
        ...
        let (_, account, _, price, _, is_bid, _, _) =
    ...
    fun test_invalid_bid_prices_not_descending() {
        ...
        let (request_option, rejection_reason_option) =
            destroy_bulk_order_request_response(response);
    ...
    fun test_spread_crossing_prevented_by_active_order_book() {
        ...
        let response2 =
            order_book.place_bulk_order(
                &mut price_time_index, &mut id_gen, order_request_2
            );
        ...
        ) = destroy_bulk_order_place_success_response(response2);
    ...
    fun test_sequence_number_validation() {
        ...
        let response1 =
            order_book.place_bulk_order(&mut price_time_index, &mut id_gen, order_req1);
        ...
        ) = destroy_bulk_order_place_success_response(response1);
        ...
        let response2 =
            order_book.place_bulk_order(&mut price_time_index, &mut id_gen, order_req2);
        assert!(is_bulk_order_success_response(&response2));
        let (
            _order2,
        ...
        let response3 =
            order_book.place_bulk_order(&mut price_time_index, &mut id_gen, order_req3);
