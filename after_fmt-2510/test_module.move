module 0x815::test_module {
    ...
    fun init_module(account: &signer) {
        let event_stream_ok = EventV1StreamOk { events: account::new_event_handle(account) };
        move_to(account, event_stream_ok);
        let event_stream_err =
            EventV1StreamErr { events: account::new_event_handle(account) };
