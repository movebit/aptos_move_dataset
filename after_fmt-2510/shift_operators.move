...
script {
    fun main() {
        ...
        assert!(
            43152365326753472145312542634526753u128 >> 127u8 == 0u128, 4002
        );
...
script {
    fun main() {
        ...
        assert!(
            345325745376476456u64 << 47u8 == 2203386117691015168u64, 6102
        );

        assert!(
            95712896789423756892376u128 << 4u8 == 1531406348630780110278016u128,
            6200
        );
        assert!(
        ...
        assert!(
            123453678909u256 << 76u8 == 9327896247469005265829994770202624u256,
            6502
        );
        assert!(
