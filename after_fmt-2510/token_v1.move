module addr::token_v1 {
    ...
    public entry fun run(creator: &signer) {
        ...
        let default_keys = vector<String>[
            ...
            string::utf8(b"TOKEN_BURNABLE_BY_OWNER")
        ];
        ...
        let updated_pm =
            token::get_property_map(signer::address_of(creator), new_token_id);
        ...
        token::mutate_tokendata_description(
            creator, token_data_id, string::utf8(b"new_description")
        );
        ...
        token::mutate_collection_description(
            creator,
            string::utf8(COLLECTION_NAME),
            string::utf8(b"new_collection_description")
        );
        token::mutate_collection_uri(
            creator,
            string::utf8(COLLECTION_NAME),
            string::utf8(b"new_collection_uri")
        );
