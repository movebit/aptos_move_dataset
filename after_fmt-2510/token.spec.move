spec aptos_token::token {
    ...
    spec mint_script(
        ...
        include CreateTokenDataIdAbortsIf { creator: token_data_address, collection, name };

        include MintTokenAbortsIf { token_data_id };
    }
    ...
    spec direct_transfer_script(
        ...
        pragma aborts_if_is_partial;
        include CreateTokenDataIdAbortsIf { creator: creators_address, collection, name };
    }
    ...
    spec mutate_collection_description(
        ...
        include AssertCollectionExistsAbortsIf { creator_address: addr, collection_name };
    ...
    spec create_tokendata(
        ...
        include CreateTokenDataIdAbortsIf { creator: account_addr, collection, name };
