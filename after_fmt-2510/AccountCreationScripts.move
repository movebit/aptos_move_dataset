module DiemFramework::AccountCreationScripts {
    ...
    public entry fun create_child_vasp_account<CoinType>(
        ...
        if (child_initial_balance > 0) {
            let vasp_withdrawal_cap =
                DiemAccount::extract_withdraw_capability(&parent_vasp);
    ...
    spec create_child_vasp_account {
        ...
        include DiemAccount::CreateChildVASPAccountAbortsIf<CoinType> {
            parent: parent_vasp,
            new_account_address: child_address
        };
        ...
        include (child_initial_balance > 0) ==>
            DualAttestation::AssertPaymentOkAbortsIf<CoinType> {
                payer: parent_addr,
                payee: child_address,
                metadata: x"",
        ...
        aborts_with [check] errors::REQUIRES_ROLE, errors::ALREADY_PUBLISHED, errors::LIMIT_EXCEEDED, errors::NOT_PUBLISHED, errors::INVALID_STATE, errors::INVALID_ARGUMENT;
    ...
    spec create_validator_operator_account {
        ...
        aborts_with [check] errors::INVALID_ARGUMENT, errors::NOT_PUBLISHED, errors::REQUIRES_ADDRESS, errors::ALREADY_PUBLISHED, errors::REQUIRES_ROLE;
    ...
    spec create_parent_vasp_account {
        ...
        include DiemAccount::CreateParentVASPAccountAbortsIf<CoinType> {
            creator_account: tc_account
        };
        include DiemAccount::CreateParentVASPAccountEnsures<CoinType>;

        aborts_with [check] errors::INVALID_ARGUMENT, errors::REQUIRES_ADDRESS, errors::NOT_PUBLISHED, errors::ALREADY_PUBLISHED, errors::REQUIRES_ROLE;
    ...
    spec create_designated_dealer {
        ...
        include DiemAccount::CreateDesignatedDealerAbortsIf<Currency> {
            creator_account: tc_account,
            new_account_address: addr
        };
        include DiemAccount::CreateDesignatedDealerEnsures<Currency> {
            new_account_address: addr
        };
