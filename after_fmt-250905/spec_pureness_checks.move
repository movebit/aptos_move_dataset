module 0x42::m {
    ...
    spec fun can_call_pure(): u64 {
        pure(1)
    }

    spec fun cannot_call_impure(x: u64): u64 {
        impure_borrow(1)
    }

    spec fun cannot_call_impure_indirect(x: u64): u64 {
        impure_indirect(1)
    }

    spec fun cannot_call_impure_assign(x: u64): u64 {
        impure_assign(x)
    }

    spec fun cannot_return(): u64 {
        uses_return(2)
    }
