...
module 0x2::M {
    ...
    // uint8[2][]
    #[callable(sig = b"test_u8(uint8[2][]) returns (uint8)")]
    fun test_one_elem_para_array_dynamic_array_2_u8(
        v: vector<vector<u8>>
    ): u8 {
    ...
    // uint8[][2]
    #[callable(sig = b"test_u8(uint8[][2]) returns (uint8)")]
    fun test_one_elem_para_array_2_array_dynamic_u8(
        v: vector<vector<u8>>
    ): u8 {
        let i = 0;
        let sum = 0;
    ...
    // uint64[2][]
    #[callable(sig = b"test_u64(uint64[2][]) returns (uint64)")]
    fun test_one_elem_para_array_dynamic_array_2_u64(
        v: vector<vector<u64>>
    ): u64 {
        let len_v = vector::length(&v);
        let i = 0;
    ...
    // uint64[][2]
    #[callable(sig = b"test_u64(uint64[][2]) returns (uint64)")]
    fun test_one_elem_para_array_2_array_dynamic_u64(
        v: vector<vector<u64>>
    ): u64 {
        let i = 0;
        let sum = 0;
    ...
    fun test_one_elem_para_array_dynamic_array_u128(
        v: vector<vector<u128>>
    ): u128 {
        let len_v = vector::length(&v);
        let i = 0;
        let sum = 0;
    ...
    fun test_one_elem_para_array_dynamic_array_2_u256(
        v: vector<vector<U256>>
    ): U256 {
        let len_v = vector::length(&v);
        let i = 0;
        let sum = U256::zero();
    ...
    fun test_one_elem_para_array_2_array_dynamic_u256(
        v: vector<vector<U256>>
    ): U256 {
        let i = 0;
        let sum = U256::zero();
