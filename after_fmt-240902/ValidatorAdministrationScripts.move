...
module ValidatorAdministrationScripts {
    ...
    spec add_validator_and_reconfigure {
        ...
        aborts_if ValidatorConfig::get_human_name(validator_address) != validator_name with
            0;
        ...
        aborts_with [check] 0, // Odd error code in assert on second statement in add_validator_and_reconfigure
        errors::INVALID_ARGUMENT, errors::NOT_PUBLISHED, errors::REQUIRES_ADDRESS, errors::INVALID_STATE, errors::LIMIT_EXCEEDED, errors::REQUIRES_ROLE;
    ...
    spec register_validator_config {
        ...
        aborts_if signer::address_of(validator_operator_account)
            != ValidatorConfig::get_operator(validator_account) with errors::INVALID_ARGUMENT;
    }
    ...
    spec remove_validator_and_reconfigure {
        ...
        /// in practice because it aborts with NOT_PUBLISHED or REQUIRES_ADDRESS, first.
        aborts_with [check] 0, // Odd error code in assert on second statement in add_validator_and_reconfigure
        errors::INVALID_ARGUMENT, errors::NOT_PUBLISHED, errors::REQUIRES_ADDRESS, errors::INVALID_STATE, errors::REQUIRES_ROLE;
    ...
    spec set_validator_config_and_reconfigure {
        ...
        include DiemSystem::UpdateConfigAndReconfigureEnsures {
        ...
        aborts_if is_validator_info_updated
            && last_config_time > DiemSystem::MAX_U64 - DiemSystem::FIVE_MINUTES with errors::LIMIT_EXCEEDED;
        aborts_if is_validator_info_updated
            && DiemTimestamp::spec_now_microseconds()
                <= last_config_time + DiemSystem::FIVE_MINUTES with errors::LIMIT_EXCEEDED;
    ...
    spec set_validator_operator {
        ...
        include ValidatorConfig::SetOperatorEnsures {
            validator_account: account,
            operator_addr: operator_account
        };
        ...
        aborts_with [check] 0, // Odd error code in assert on second statement in add_validator_and_reconfigure
        errors::INVALID_ARGUMENT, errors::NOT_PUBLISHED, errors::REQUIRES_ROLE;
