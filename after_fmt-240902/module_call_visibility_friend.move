...
module M {
    ...
    public(friend) fun f_friend_call_public() {
        X::f_public()
    }

    // a public(friend) fun can call private and public funs defined in its own module
    public(friend) fun f_friend_call_self_private() {
        Self::f_private()
    }

    public(friend) fun f_friend_call_self_public() {
        Self::f_public()
    }
    ...
    // as well as friend functions defined in other modules (subject to friend list)
    public(friend) fun f_friend_call_friend() {
        Y::f_friend()
    }

    public(friend) fun f_friend_call_self_friend() {
        Self::f_friend()
    }
