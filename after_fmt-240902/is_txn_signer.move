...
module 0x42::SimpleIsTxnSigner {
    ...
    public fun f1_incorrect() {
        ...
        } // This is unprovable because it is not true in general.
    }
    ...
    fun f5() {
        spec {
            assert signer::is_txn_signer_addr(@0x7);
        } // This is provable because of the "requires" condition.
    }
    ...
    public fun publish(account: &signer) {
        spec {
            assume signer::is_txn_signer_addr(signer::address_of(account));
        };
