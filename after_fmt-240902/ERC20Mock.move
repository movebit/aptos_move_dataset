...
module Evm::ERC20Mock {
    ...
    public fun increaseAllowance(
        state: &mut State, spender: address, addedValue: U256
    ): bool {
        let owner = sender();
    ...
    public fun decreaseAllowance(
        state: &mut State, spender: address, subtractedValue: U256
    ): bool {
        let owner = sender();
