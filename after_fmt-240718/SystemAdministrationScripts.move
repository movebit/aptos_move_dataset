...
module ExperimentalFramework::SystemAdministrationScripts {
    ...
    public entry fun update_diem_version(
        account: signer, _sliding_nonce: u64, major: u64
    ) {
    ...
    public entry fun initialize_diem_consensus_config(
        account: signer, _sliding_nonce: u64
    ) {
    ...
    public entry fun update_diem_consensus_config(
        account: signer, _sliding_nonce: u64, config: vector<u8>
    ) {
