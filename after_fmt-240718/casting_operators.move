...
script {
    fun main() {
        ...
        assert!(
            (340282366920938463463374607431768211455u128 as u128)
        ...
        assert!(
            (340282366920938463463374607431768211455u256 as u128)
                == 340282366920938463463374607431768211455u128,
            3202,
        );
    }
...
script {
    fun main() {
        ...
        assert!(
            (340282366920938463463374607431768211455u128 as u256)
        ...
        assert!(
            (
                ...
                115792089237316195423570985008687907853269984665640564039457584007913129639935u256 as u256
            ) ==
