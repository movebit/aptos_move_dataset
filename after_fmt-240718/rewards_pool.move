...
module rewards_pool::rewards_pool {
    ...
    public fun create(reward_tokens: vector<Object<Metadata>>): Object<RewardsPool> {
        ...
        vector::for_each(
            ...
            |reward_token| {
                ...
                let store =
                    fungible_asset::create_store(store_constructor_ref, reward_token);
                simple_map::add(
                    &mut reward_stores,
                    reward_token,
                    RewardStore {
    ...
    public fun claimer_shares(
        ...
        let epoch_rewards =
            smart_table::borrow(
                &safe_rewards_pool_data(&rewards_pool).epoch_rewards, epoch
            );
    ...
    public fun claim_rewards(
        ...
        if (all_shares > 0) {
            pool_u64::redeem_shares(
                &mut epoch_rewards.claimer_pool, claimer_addr, all_shares
            );
        };
