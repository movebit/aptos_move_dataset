...
module 0xcafe::ConstantFailure {
    ...
    fun main() {
        ...
        let fail_u32 = vector<u32>[
            1 << 32, (1u8 << 8 as u32), ((1u16 << 16) as u32), 0 >> 32, ((0u8 >> 8) as u32), (
                (0u16 >> 16) as u32
            ), 1 / 0, 1 % 0, 4294967295 + 4294967295, ((65535u16 + 65535) as u32), (
                (65535 + 65535u16) as u32
            ), ((65535u16 + 65535u16) as u32), 0 - 1, ((4294967296: u128) as u32)
        ];
        let fail_u64 = vector<u64>[
            1 << 64, ((1u32 << 32) as u64), 0 >> 64, ((0u32 >> 32) as u64), 1 / 0, 1
                % 0, 18446744073709551615 + 18446744073709551615, ((255u8 + 255) as u64), (
                (255 + 255u8) as u64
            ), ((255u8 + 255u8) as u64), ((4294967295u32 + 4294967295) as u64), (
                (4294967295 + 4294967295u32) as u64
            ), ((4294967295u32 + 4294967295u32) as u64), 0 - 1, (
                (340282366920938463463374607431768211450: u128) as u64
            )
        ];
        let fail_u128 = vector<u128>[
            1 << 128, ((1u64 << 64) as u128), 0 >> 128, ((0u64 >> 64) as u128), 1 / 0, 1
                % 0, 340282366920938463463374607431768211450
            ...
            ), 0 - 1, ((340282366920938463463374607431768211456: u256) as u128)
        ];
        let fail_u256 = vector<u256>[
            ...
            (
                (
                    340282366920938463463374607431768211450u128
                        + 340282366920938463463374607431768211450
                ) as u256
            ),
            (
