module bonding_curve_launchpad::bonding_curve_launchpad {
    ...
    fun create_fa(
        ...
        let does_fa_exist =
            object::object_exists<FAController>(get_fa_obj_address(name, symbol));
        ...
        let fa_generator_signer =
            object::generate_signer_for_extending(&launchpad.fa_generator_extend_ref);
