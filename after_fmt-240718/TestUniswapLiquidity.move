...
module Evm::TestUniswapLiquidity {
    ...
    public fun addLiquidity(
        ...
        let const_ROUTER =
            U256::to_address(
                u256_from_words(0x7a250d56, 0x30B4cF539739dF2C5dAcb4c659F2488D)
            );
        ...
        let (_amountA, _amountB, _liquidity) =
            IUniswapV2Router::call_addLiquidity(
                const_ROUTER,
                tokenA,
                tokenB,
                amountA,
    ...
    public fun removeLiquidity(tokenA: address, tokenB: address,) {
        ...
        let const_FACTORY =
            U256::to_address(
                u256_from_words(0x5C69bEe7, 0x01ef814a2B6a3EDD4B1652CB9cc5aA6f)
            );
        let const_ROUTER =
            U256::to_address(
                u256_from_words(0x7a250d56, 0x30B4cF539739dF2C5dAcb4c659F2488D)
        ...
        let (_amountA, _amountB) =
            IUniswapV2Router::call_removeLiquidity(
                const_ROUTER,
                tokenA,
                tokenB,
                liquidity,
