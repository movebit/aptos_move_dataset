...
module swap::liquidity_pool_tests {
    ...
    fun test_e2e_volatile(lp_1: &signer, lp_2: &signer) {
        ...
        let expected_liq_2 =
            expected_total_reserves_2 * lp_tokens_to_withdraw / total_lp_supply;
        let (liq_1, liq_2) =
            liquidity_pool::burn(
                lp_1,
    ...
    fun verify_reserves(
        pool: Object<LiquidityPool>, expected_1: u64, expected_2: u64
    ) {
    ...
    public fun create_pool(lp_1: &signer, is_stable: bool)
        ...
        let tokens_2 =
            test_helpers::create_fungible_asset_and_mint(lp_1, b"test2", 10000000);
        let pool =
