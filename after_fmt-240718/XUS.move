...
module DiemFramework::XUS {
    ...
    spec initialize {
        ...
        include AccountLimits::PublishUnrestrictedLimitsEnsures<XUS> {
            publish_account: dr_account
        };
    ...
    spec module {
        ...
        invariant [suspendable] forall addr: address where exists<AccountLimits::LimitsDefinition<XUS>>(
            addr
        ): addr == @DiemRoot;
    ...
    spec module {
        ...
        invariant update forall a: address where old(exists<Diem::MintCapability<XUS>>(a)): exists<Diem::MintCapability<XUS>>(
            a
        );
    }
    ...
    spec module {
        ...
        invariant update[suspendable] forall a: address where old(
