...
script {
    fun main() {
        ...
        assert!(
            5u128 + 340282366920938463463374607431768211450u128
                == 340282366920938463463374607431768211455u128,
            1202,
        );
    }
...
script {
    fun main() {
            // should fail
            264235234643575437864589745863652363451u128
            + 98731747836156137656137643716471364731u128;
    }
}
...
script {
    fun main() {
        ...
        assert!(
            170141183460469231731687303715884105727u128 * 2u128
...
script {
    fun main() {
        ...
        assert!(
            340282366920938463463374607431768211455u128 / 4315342637u128
                == 78854078469537403609736727246u128,
            4101,
        );
...
script {
    fun main() {
        ...
        assert!(
            340282366920938463463374607431768211455u128 % 4315342637u128 == 2264823753u128,
            5101,
        );
