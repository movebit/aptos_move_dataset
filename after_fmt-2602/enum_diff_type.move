module 0x815::m {
    ...
    fun test_data_invariant() {
        let common = CommonFields::Bar { x: 30, y: 40, z: 50 };
    ...
    enum CommonFieldsVector has drop {
        ...
        Bar {
            x: vector<u8>,
            y: vector<CommonFields>
        }
    }

    fun test_enum_vector() {
        let _common_vector_1 = CommonFieldsVector::Foo { x: vector[2] };
        let _common_fields = CommonFields::Bar { x: 30, y: 40, z: 50 };
        let _common_vector_2 =
            CommonFieldsVector::Bar {
                x: vector[2],
