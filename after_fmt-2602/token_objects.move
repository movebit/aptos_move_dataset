module addr::token_objects {
    ...
    public entry fun set_ambassador_level(
        creator: &signer, token: Object<AmbassadorToken>, new_ambassador_level: u64
    ...
    fun update_ambassador_rank(
        token: Object<AmbassadorToken>, new_ambassador_level: u64
    ) acquires AmbassadorToken {
        // `new_rank` is determined based on the new level.
        let new_rank =
            if (new_ambassador_level < 10) {
                RANK_BRONZE
    ...
    public entry fun run(
        creator: &signer, user_addr: address
    ) acquires AmbassadorToken, AmbassadorLevel {
        // ------------------------------------------
