...
script {
    fun main() {
        ...
        assert!(
            0u64 + 18446744073709551615u64 == 18446744073709551615u64, 1200
        );
        assert!(
            1u64 + 18446744073709551614u64 == 18446744073709551615u64, 1201
        );
        assert!(
            5u64 + 18446744073709551610u64 == 18446744073709551615u64, 1202
        );
    }
}
...
script {
    fun main() {
        ...
        assert!(
            18446744073709551615u64 - 18446744073709551615u64 == 0u64, 2200
        );
...
script {
    fun main() {
        ...
        assert!(
            9223372036854775807u64 * 2u64 == 18446744073709551614u64, 3200
        );
    }
}
...
script {
    fun main() {
        ...
        assert!(
            18446744073709551615u64 / 13131u64 == 1404824009878116u64, 4101
        );

        assert!(
            18446744073709551614u64 / 18446744073709551615u64 == 0u64, 4200
        );
        assert!(
            18446744073709551615u64 / 18446744073709551615u64 == 1u64, 4201
        );
    }
}
...
script {
    fun main() {
        ...
        assert!(
            18446744073709551615u64 % 13131u64 == 10419u64, 5101
        );

        assert!(
            18446744073709551614u64 % 18446744073709551615u64
                == 18446744073709551614u64,
            5200
        );
        assert!(
            18446744073709551615u64 % 18446744073709551615u64 == 0u64, 5201
        );
    }
}
