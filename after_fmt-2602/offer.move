...
module std::offer {
    ...
    public fun create<Offered: store>(
        account: &signer, offered: Offered, for: address
    ) {
        assert!(
    ...
    spec create {
        ...
        ensures global<Offer<Offered>>(signer::address_of(account))
            == Offer<Offered> { offered: offered, for: for };
    }
    ...
    public fun redeem<Offered: store>(
    ...
    spec redeem {
        ...
        aborts_if !is_allowed_recipient<Offered>(
    ...
    spec module {
        ...
        /// and false otherwise.
        fun is_allowed_recipient<Offered>(
            offer_addr: address, recipient: address
        ): bool {
